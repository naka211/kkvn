...
<div class="col-sm-4">
	...
	<div class="row list-user-box">
		...
		?>
		<div class="col-sm-3 user-item"> <a href="index.php?option=com_users&view=user&id=<?php echo $item->id;?>"  data-toggle="tooltip" data-placement="top" title="<?php echo $item->name;?>">
